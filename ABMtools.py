...
class Group:
    ...
    def ungroup(self, kill=False, controller=None):
        ...
        controller=None (ABMTools.Controller): Controller to which agents in group are attached. Defaults to  own
            controller if None

        If kill: remove all agents in Group member list from Controller Agent list
        If !kill: set group to None for all agents in Group member list
        """
        # Remove all members from the group
